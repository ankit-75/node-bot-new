...
module.exports = async bp => {
  ...
  if (bp.nlu && bp.nlu.provider && bp.nlu.provider.name === 'native') {
    ...
    //console.log(bp.nlu.provider);
    await bp.nlu.provider.sync()
  }

 /* console.log("________________")
  //console.log(bp)
  console.log(bp.botfile)
  console.log("________________")*/
  const webchat = {
    botName: 'Basic',
    botAvatarUrl: `${bp.botfile.botUrl}/media/micra.png`, // You can provide a URL here
    botConvoTitle: 'Botpress Basic Webchat Bot',
    botConvoDescription: "Hello, I'm a Botpress bot!",
    //backgroundColor: '#ffffff',
    //textColorOnBackground: '#666666',
    //foregroundColor: '#000000',
    customStylesheet: `${bp.botfile.botUrl}/media/style.css`,
